// MAD CREDIT TO DA0DA0 Team - TYSM frenz!
...
export function normalizeMessage(msg: any) {
  const s = typeof msg === 'object' ? JSON.stringify(msg) : msg
...
export function encodeMessage(msg: any) {
  return toBase64(toUtf8(JSON.stringify(normalizeMessage(msg))))
}
    ...
    if ('execute' in wasmMsg) {
      const encodeObject: MsgExecuteContractEncodeObject = {
        ...
        value: {
          ...
          msg: typeof wasmMsg.execute.msg !== 'string' ? fromBase64(encodeMessage(wasmMsg.execute.msg)) : fromBase64(wasmMsg.execute.msg),
        },
      }
      return encodeObject
    }
